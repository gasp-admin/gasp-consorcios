...
const BUILD_VERSION = '20260521-cert-preload-v38'
  ...
  async function leerDesdeDrive() {
    ...
    try {
      const { data, error } = await supabase.from('con_consorcios').select(
        'matricula_rpi, escritura_nro, escritura_fecha, poliza_nro, poliza_compania, poliza_vto_desde, poliza_vto_hasta, poliza_suma, tiene_cocheras_tasas, tiene_fondo_reserva'
