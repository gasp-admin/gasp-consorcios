...
const BUILD_VERSION = '20260520-drive-carpetas-v21'
      ...
      {paso === 1 && (
        <div>
          <Card style={{ marginBottom:16 }}>
            ...
            {consorcioActivo?.drive_folder_url && (
              <a href={consorcioActivo.drive_folder_url} target="_blank" rel="noreferrer"
                style={{ display:'flex', alignItems:'center', gap:8, padding:'10px 14px',
                  background:'#f0fdf4', border:'1px solid #bbf7d0', borderRadius:8,
                  marginBottom:12, fontSize:12, fontWeight:600, color:'#14532d',
                  textDecoration:'none' }}>
                <span style={{ fontSize:16 }}>📁</span>
                <div>
                  <div>Carpeta de documentos</div>
                  <div style={{ fontSize:10, fontWeight:400, color:'#166534', marginTop:1 }}>
                    Reglamento · Planos · Actas · Liquidaciones
                  </div>
                </div>
              </a>
            )}
...
function EnviarEmails({ session, consorcioId, unidades, adminPerfil }) {
  ...
  return (
    <div>
      ...
      {/* Aviso Drive si existe */}
      {consorcioActivo?.drive_folder_url && (
        <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:14, padding:'11px 16px',
          background:'#f0fdf4', border:'1px solid #bbf7d0', borderRadius:8 }}>
          <span style={{ fontSize:20 }}>📁</span>
          <div style={{ flex:1 }}>
            <div style={{ fontWeight:600, fontSize:13, color:'#14532d' }}>
              La liquidación incluirá el acceso a la carpeta Drive del consorcio
            </div>
            <div style={{ fontSize:11, color:'#166534', marginTop:2 }}>
              Los propietarios recibirán un botón para acceder a: reglamento, planos, actas y liquidaciones históricas.
            </div>
          </div>
          <a href={consorcioActivo.drive_folder_url} target="_blank" rel="noreferrer"
            style={{ fontSize:12, color:'#14532d', fontWeight:600, textDecoration:'underline', whiteSpace:'nowrap' }}>
            Ver carpeta →
          </a>
        </div>
      )}
      ...
      <div>
        ...
        {formCon && (
          <Card style={{ marginBottom:20, border:`1px solid ${AZ}` }}>
            ...
            <div style={{ fontWeight:600, color:GR, fontSize:12, marginBottom:10, textTransform:'uppercase', letterSpacing:'0.5px' }}>Documentación — Google Drive</div>
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12, marginBottom:16 }}>
              <div style={{ gridColumn:'span 2' }}>
                <Input label="URL carpeta Drive del consorcio"
                  value={formCon.drive_folder_url||''}
                  onChange={v=>setFormCon(x=>({...x,drive_folder_url:v,drive_folder_id:v.includes('folders/')?(v.split('folders/')[1].split('?')[0].split('/')[0]):(x.drive_folder_id||'')}))}
                  placeholder="https://drive.google.com/drive/folders/..." />
                <div style={{ fontSize:11, color:GR, marginTop:4 }}>
                  Se incluirá en el email de la liquidación y en el portal de cada copropietario.
                  Asegúrese de que la carpeta sea pública o compartida con los propietarios.
                </div>
              </div>
            </div>
            <div style={{ display:'flex', gap:8 }}>
                  ...
                  {consorcioActivo.drive_folder_url && (
                    <a href={consorcioActivo.drive_folder_url} target="_blank" rel="noreferrer"
                      style={{ display:'inline-flex', alignItems:'center', gap:6, marginTop:8,
                        background:'rgba(255,255,255,0.15)', color:'#fff', padding:'5px 12px',
                        borderRadius:6, fontSize:12, fontWeight:600, textDecoration:'none', border:'1px solid rgba(255,255,255,0.3)' }}>
                      📁 Carpeta documentos en Drive
                    </a>
                  )}
                </div>
