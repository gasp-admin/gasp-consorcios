...
const BUILD_VERSION = '20260520-ctacte-periodos-v19'
    ...
    <div>
      ...
      <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
        {expensas.map(exp=>{
          ...
          return (
            <Card key={exp.id} style={{ cursor:'pointer', opacity: esCerradaItem ? 0.88 : 1 }}
              ...
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                <div>
                  <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:4 }}>
                    ...
                    {esCerradaItem && <span style={{ fontSize:11, color:'#374151' }}>🔒</span>}
                  </div>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:8 }}>
                  {esCerradaItem && (
                    <span style={{ fontSize:11, color:'#374151', background:'#f3f4f6',
                      padding:'3px 8px', borderRadius:4 }}>Ver liquidación</span>
                  )}
