    ...
    <div style={{ padding: 20, maxWidth: 1100, margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        <div>
          ...
          <p style={{ margin: '4px 0 0', color: '#6b7280', fontSize: 13 }}>Mis Expensas v37 — Flujo automático por tamaño y formato</p>
        </div>
      ...
      {tab === 'importar' && (
        <div>
          ...
          <div style={{ ...card, background: '#f0fdf4', border: '1px solid #bbf7d0' }}>
            <h4 style={{ margin: '0 0 8px', fontSize: 13, color: '#166534' }}>✅ Flujo v37</h4>
            <ul style={{ margin: 0, paddingLeft: 20, fontSize: 12, color: '#166534', lineHeight: 1.8 }}>
              <li><b>meta</b>: extrae período, rubros, estado financiero</li>
              <li><b>≤30 UFs</b>: prorrateo en una sola llamada via <code>procesar_prorrateo_rango</code></li>
              <li><b>&gt;30 UFs</b>: rangos de 25 UFs secuenciales</li>
              <li><b>con_subtotal</b>: Ática II (columna SUBTOTAL detectada automáticamente)</li>
            </ul>
          </div>
        </div>
      )}
